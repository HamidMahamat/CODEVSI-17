...
mafigure = Figure(figsize=(5, 4), dpi=100)
mon_subplot = mafigure.add_subplot(111)
"""
plt.figure()
plt.xlabel(r'$\beta$')
...
mon_subplot.plot(X_dte(0), (c0/(2*10**u*scipy.pi))*Y_dte(0), label='TE0')
mon_subplot.plot(X_dtm(0), (c0/(2*10**u*scipy.pi))*Y_dtm(0), label='TM0')
